...
[Selected work](/record/) · [EasyPost biography](https://www.easypost.com/about/) · [Professional profile](https://www.linkedin.com/in/lanejoshlane/)

## Open source {#open-source}

I contribute to tools I use, including [ogen, jnv, hotreload.nvim, and Sinatra](/record/#open-source). I also helped get [fog-aws](https://github.com/fog/fog-aws) started; I no longer actively maintain it.

I use [Neovim](https://neovim.io/) for coding and personal knowledge management, and have [supported the project financially](https://neovim.io/sponsors/) through recurring donations for years.
